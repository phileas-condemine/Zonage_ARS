...
output: 
  word_document:
    reference_docx: utils/modele_word_arrete.docx
params: 
...
## relatif à la détermination des zones caractérisées par une offre de soins insuffisante ou par des difficultés dans l’accès aux soins ou dans lesquelles le niveau de l’offre est particulièrement élevé pour la profession de d’infirmier
...
Vu l’avis de la conférence régionale de la santé et de l’autonomie en date du `params$DATE_DECISION_CONF_SANTE_AUTO` ;
...
-	la liste des communes et  des bassins de vie/cantons-ou-villes de la région `r params$REGION_NAME` qualifiés par l’ARS `r params$REGION_NAME` figure en annexe 1 du présent arrêté ; 
