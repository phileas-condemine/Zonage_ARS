...
## relatif à la définition des zones de mise en œuvre des mesures destinées à favoriser une meilleure répartition géographique des sages-femmes libérales
...
**Article 2** : Les zones de mise en œuvre des mesures destinées à favoriser une meilleure répartition des sages-femmes libérales sont arrêtées ainsi qu'il suit en région `r params$REGION_NAME`.
